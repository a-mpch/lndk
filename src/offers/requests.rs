...
use super::{handler::SendPaymentParams, validate_amount, OfferError};
...
mod tests {
    ...
    use super::*;
    use crate::offers::traits::tests::{
        MockTestBolt12InvoiceCreator, MockTestOfferCreator, MockTestPeerConnector,
    };
    use crate::offers::{decode, traits::tests::MockTestInvoicePayer};
    use lightning::{
